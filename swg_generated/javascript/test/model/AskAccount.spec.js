...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AskAccount', function() {
      beforeEach(function() {
        instance = new UpbitOpenApi.AskAccount();
      });

      it('should create an instance of AskAccount', function() {
        // TODO: update the code to test AskAccount
        expect(instance).to.be.a(UpbitOpenApi.AskAccount);
      });
