...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CandleDays', function() {
      beforeEach(function() {
        instance = new UpbitOpenApi.CandleDays();
      });

      it('should create an instance of CandleDays', function() {
        // TODO: update the code to test CandleDays
        expect(instance).to.be.a(UpbitOpenApi.CandleDays);
      });
      ...
      it('should have the property convertedTradePrice (base name: "converted_trade_price")', function() {
        // TODO: update the code to test the property convertedTradePrice
        expect(instance).to.have.property('convertedTradePrice');
        // expect(instance.convertedTradePrice).to.be(expectedValueLiteral);
      });
