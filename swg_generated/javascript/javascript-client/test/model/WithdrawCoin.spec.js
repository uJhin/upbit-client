...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WithdrawCoin', function() {
      beforeEach(function() {
        instance = new UpbitOpenApi.WithdrawCoin();
      });

      it('should create an instance of WithdrawCoin', function() {
        // TODO: update the code to test WithdrawCoin
        expect(instance).to.be.a(UpbitOpenApi.WithdrawCoin);
      });
      ...
      it('should have the property krwAmount (base name: "krw_amount")', function() {
        // TODO: update the code to test the property krwAmount
        expect(instance).to.have.property('krwAmount');
        // expect(instance.krwAmount).to.be(expectedValueLiteral);
      });
