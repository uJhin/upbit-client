...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.UpbitOpenApi.CandleDays = factory(root.UpbitOpenApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CandleDays model module.
   * @module model/CandleDays
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CandleDays</code>.
   * @alias module:model/CandleDays
   * @class
   */
  ...
  /**
   * Constructs a <code>CandleDays</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CandleDays} obj Optional instance to populate.
   * @return {module:model/CandleDays} The populated <code>CandleDays</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('converted_trade_price'))
        obj.convertedTradePrice = ApiClient.convertToType(data['converted_trade_price'], 'Number');
    }
    return obj;
  }
   ...
   * @member {Number} convertedTradePrice
   */
  exports.prototype.convertedTradePrice = undefined;
