...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('./Trade'));
  } else {
    // Browser globals (root is window)
    if (!root.UpbitOpenApi) {
      root.UpbitOpenApi = {};
    }
    root.UpbitOpenApi.OrderInfo = factory(root.UpbitOpenApi.ApiClient, root.UpbitOpenApi.Trade);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('trades'))
        obj.trades = ApiClient.convertToType(data['trades'], [Trade]);
    }
    return obj;
  }
  ...
  /**
   * 체결
   * @member {Array.<module:model/Trade>} trades
   */
