...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.UpbitOpenApi.CandleMinutes = factory(root.UpbitOpenApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CandleMinutes model module.
   * @module model/CandleMinutes
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CandleMinutes</code>.
   * @alias module:model/CandleMinutes
   * @class
   */
  ...
  /**
   * Constructs a <code>CandleMinutes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CandleMinutes} obj Optional instance to populate.
   * @return {module:model/CandleMinutes} The populated <code>CandleMinutes</code> instance.
   */
