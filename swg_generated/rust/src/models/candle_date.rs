...
pub struct CandleDate {
  ...
  /// 캔들 기간의 가장 첫 날
  #[serde(rename = "first_day_of_period")]
  first_day_of_period: Option<String>
}

impl CandleDate {
  pub fn new() -> CandleDate {
    CandleDate {
      market: None,
  ...
  pub fn with_market(mut self, market: String) -> CandleDate {
    self.market = Some(market);
    self
  }
  ...
  pub fn with_candle_date_time_utc(mut self, candle_date_time_utc: String) -> CandleDate {
    self.candle_date_time_utc = Some(candle_date_time_utc);
    self
  }
  ...
  pub fn with_candle_date_time_kst(mut self, candle_date_time_kst: String) -> CandleDate {
    self.candle_date_time_kst = Some(candle_date_time_kst);
    self
  }
  ...
  pub fn with_opening_price(mut self, opening_price: f64) -> CandleDate {
    self.opening_price = Some(opening_price);
    self
  }
  ...
  pub fn with_high_price(mut self, high_price: f64) -> CandleDate {
    self.high_price = Some(high_price);
    self
  }
  ...
  pub fn with_low_price(mut self, low_price: f64) -> CandleDate {
    self.low_price = Some(low_price);
    self
  }
  ...
  pub fn with_trade_price(mut self, trade_price: f64) -> CandleDate {
    self.trade_price = Some(trade_price);
    self
  }
  ...
  pub fn with_timestamp(mut self, timestamp: f32) -> CandleDate {
    self.timestamp = Some(timestamp);
    self
  }
  ...
  pub fn with_candle_acc_trade_price(mut self, candle_acc_trade_price: f64) -> CandleDate {
    self.candle_acc_trade_price = Some(candle_acc_trade_price);
    self
  }
  ...
  pub fn with_candle_acc_trade_volume(mut self, candle_acc_trade_volume: f64) -> CandleDate {
    self.candle_acc_trade_volume = Some(candle_acc_trade_volume);
    self
  }
  ...
  pub fn set_first_day_of_period(&mut self, first_day_of_period: String) {
    self.first_day_of_period = Some(first_day_of_period);
  }

  pub fn with_first_day_of_period(mut self, first_day_of_period: String) -> CandleDate {
    self.first_day_of_period = Some(first_day_of_period);
    self
  }

  pub fn first_day_of_period(&self) -> Option<&String> {
    self.first_day_of_period.as_ref()
  }

  pub fn reset_first_day_of_period(&mut self) {
    self.first_day_of_period = None;
  }
