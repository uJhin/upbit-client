...
impl Order {
  ...
  pub fn with_uuid(mut self, uuid: String) -> Order {
    self.uuid = Some(uuid);
    self
  }
  ...
  pub fn with_ord_type(mut self, ord_type: String) -> Order {
    self.ord_type = Some(ord_type);
    self
  }
  ...
  pub fn with_price(mut self, price: String) -> Order {
    self.price = Some(price);
    self
  }
  ...
  pub fn with_state(mut self, state: String) -> Order {
    self.state = Some(state);
    self
  }
  ...
  pub fn with_market(mut self, market: String) -> Order {
    self.market = Some(market);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> Order {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_volume(mut self, volume: String) -> Order {
    self.volume = Some(volume);
    self
  }
  ...
  pub fn with_remaining_volume(mut self, remaining_volume: String) -> Order {
    self.remaining_volume = Some(remaining_volume);
    self
  }
  ...
  pub fn with_reserved_fee(mut self, reserved_fee: String) -> Order {
    self.reserved_fee = Some(reserved_fee);
    self
  }
  ...
  pub fn with_remaining_fee(mut self, remaining_fee: String) -> Order {
    self.remaining_fee = Some(remaining_fee);
    self
  }
  ...
  pub fn with_paid_fee(mut self, paid_fee: String) -> Order {
    self.paid_fee = Some(paid_fee);
    self
  }
  ...
  pub fn with_locked(mut self, locked: String) -> Order {
    self.locked = Some(locked);
    self
  }
  ...
  pub fn with_executed_volume(mut self, executed_volume: String) -> Order {
    self.executed_volume = Some(executed_volume);
    self
  }
  ...
  pub fn with_trades_count(mut self, trades_count: f32) -> Order {
    self.trades_count = Some(trades_count);
    self
  }
