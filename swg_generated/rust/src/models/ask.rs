...
impl Ask {
  ...
  pub fn with_currency(mut self, currency: String) -> Ask {
    self.currency = Some(currency);
    self
  }
  ...
  pub fn with_price_unit(mut self, price_unit: String) -> Ask {
    self.price_unit = Some(price_unit);
    self
  }
  ...
  pub fn with_min_total(mut self, min_total: f32) -> Ask {
    self.min_total = Some(min_total);
    self
  }
