...
impl Deposit {
  ...
  pub fn with__type(mut self, _type: String) -> Deposit {
    self._type = Some(_type);
    self
  }
  ...
  pub fn with_uuid(mut self, uuid: String) -> Deposit {
    self.uuid = Some(uuid);
    self
  }
  ...
  pub fn with_currency(mut self, currency: String) -> Deposit {
    self.currency = Some(currency);
    self
  }
  ...
  pub fn with_txid(mut self, txid: String) -> Deposit {
    self.txid = Some(txid);
    self
  }
  ...
  pub fn with_state(mut self, state: String) -> Deposit {
    self.state = Some(state);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> Deposit {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_done_at(mut self, done_at: String) -> Deposit {
    self.done_at = Some(done_at);
    self
  }
  ...
  pub fn with_amount(mut self, amount: String) -> Deposit {
    self.amount = Some(amount);
    self
  }
  ...
  pub fn with_fee(mut self, fee: String) -> Deposit {
    self.fee = Some(fee);
    self
  }
  ...
  pub fn with_transaction_type(mut self, transaction_type: String) -> Deposit {
    self.transaction_type = Some(transaction_type);
    self
  }
