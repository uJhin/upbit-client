...
impl Account {
  ...
  pub fn with_balance(mut self, balance: String) -> Account {
    self.balance = Some(balance);
    self
  }
  ...
  pub fn with_locked(mut self, locked: String) -> Account {
    self.locked = Some(locked);
    self
  }
  ...
  pub fn with_avg_buy_price(mut self, avg_buy_price: String) -> Account {
    self.avg_buy_price = Some(avg_buy_price);
    self
  }
  ...
  pub fn with_avg_buy_price_modified(mut self, avg_buy_price_modified: bool) -> Account {
    self.avg_buy_price_modified = Some(avg_buy_price_modified);
    self
  }
  ...
  pub fn with_unit_currency(mut self, unit_currency: String) -> Account {
    self.unit_currency = Some(unit_currency);
    self
  }
