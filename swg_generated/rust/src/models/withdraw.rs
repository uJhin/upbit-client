...
impl Withdraw {
  ...
  pub fn with__type(mut self, _type: String) -> Withdraw {
    self._type = Some(_type);
    self
  }
  ...
  pub fn with_uuid(mut self, uuid: String) -> Withdraw {
    self.uuid = Some(uuid);
    self
  }
  ...
  pub fn with_currency(mut self, currency: String) -> Withdraw {
    self.currency = Some(currency);
    self
  }
  ...
  pub fn with_txid(mut self, txid: String) -> Withdraw {
    self.txid = Some(txid);
    self
  }
  ...
  pub fn with_state(mut self, state: String) -> Withdraw {
    self.state = Some(state);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> Withdraw {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_done_at(mut self, done_at: String) -> Withdraw {
    self.done_at = Some(done_at);
    self
  }
  ...
  pub fn with_amount(mut self, amount: String) -> Withdraw {
    self.amount = Some(amount);
    self
  }
  ...
  pub fn with_fee(mut self, fee: String) -> Withdraw {
    self.fee = Some(fee);
    self
  }
  ...
  pub fn with_transaction_type(mut self, transaction_type: String) -> Withdraw {
    self.transaction_type = Some(transaction_type);
    self
  }
