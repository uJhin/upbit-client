...
pub struct OrderInfo {
  ...
  /// 체결
  #[serde(rename = "trades")]
  trades: Option<Vec<::models::Trade>>
}
...
impl OrderInfo {
  ...
  pub fn with_uuid(mut self, uuid: String) -> OrderInfo {
    self.uuid = Some(uuid);
    self
  }
  ...
  pub fn with_side(mut self, side: String) -> OrderInfo {
    self.side = Some(side);
    self
  }
  ...
  pub fn with_ord_type(mut self, ord_type: String) -> OrderInfo {
    self.ord_type = Some(ord_type);
    self
  }
  ...
  pub fn with_price(mut self, price: String) -> OrderInfo {
    self.price = Some(price);
    self
  }
  ...
  pub fn with_state(mut self, state: String) -> OrderInfo {
    self.state = Some(state);
    self
  }
  ...
  pub fn with_market(mut self, market: String) -> OrderInfo {
    self.market = Some(market);
    self
  }
  ...
  pub fn with_created_at(mut self, created_at: String) -> OrderInfo {
    self.created_at = Some(created_at);
    self
  }
  ...
  pub fn with_volume(mut self, volume: String) -> OrderInfo {
    self.volume = Some(volume);
    self
  }
  ...
  pub fn with_remaining_volume(mut self, remaining_volume: String) -> OrderInfo {
    self.remaining_volume = Some(remaining_volume);
    self
  }
  ...
  pub fn with_reserved_fee(mut self, reserved_fee: String) -> OrderInfo {
    self.reserved_fee = Some(reserved_fee);
    self
  }
  ...
  pub fn with_remaining_fee(mut self, remaining_fee: String) -> OrderInfo {
    self.remaining_fee = Some(remaining_fee);
    self
  }
  ...
  pub fn with_paid_fee(mut self, paid_fee: String) -> OrderInfo {
    self.paid_fee = Some(paid_fee);
    self
  }
  ...
  pub fn with_locked(mut self, locked: String) -> OrderInfo {
    self.locked = Some(locked);
    self
  }
  ...
  pub fn with_executed_volume(mut self, executed_volume: String) -> OrderInfo {
    self.executed_volume = Some(executed_volume);
    self
  }
  ...
  pub fn with_trades_count(mut self, trades_count: f32) -> OrderInfo {
    self.trades_count = Some(trades_count);
    self
  }
  ...
  pub fn set_trades(&mut self, trades: Vec<::models::Trade>) {
    self.trades = Some(trades);
  }

  pub fn with_trades(mut self, trades: Vec<::models::Trade>) -> OrderInfo {
    self.trades = Some(trades);
    self
  }

  pub fn trades(&self) -> Option<&Vec<::models::Trade>> {
    self.trades.as_ref()
  }
