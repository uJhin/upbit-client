...
local function new_market_api(host, basePath, schemes)
	local schemes_map = {}
...
function market_api:market_info_all(is_details)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		path = string.format("%s/market/all?isDetails=%s",
			self.basePath, http_util.encodeURIComponent(is_details));
	})
