...
SWGAskAccount::SWGAskAccount(QString json) {
    init();
    this->fromJson(json);
}

SWGAskAccount::SWGAskAccount() {
    init();
}
...
SWGAskAccount*
SWGAskAccount::fromJson(QString json) {
...
void
SWGAskAccount::fromJsonObject(QJsonObject pJson) {
...
QString*
SWGAskAccount::getCurrency() {
    return currency;
}
void
SWGAskAccount::setCurrency(QString* currency) {
    this->currency = currency;
    this->m_currency_isSet = true;
}

QString*
SWGAskAccount::getBalance() {
    return balance;
}
void
SWGAskAccount::setBalance(QString* balance) {
    this->balance = balance;
    this->m_balance_isSet = true;
}

QString*
SWGAskAccount::getLocked() {
    return locked;
}
void
SWGAskAccount::setLocked(QString* locked) {
    this->locked = locked;
    this->m_locked_isSet = true;
}

QString*
SWGAskAccount::getAvgBuyPrice() {
    return avg_buy_price;
}
void
SWGAskAccount::setAvgBuyPrice(QString* avg_buy_price) {
    this->avg_buy_price = avg_buy_price;
    this->m_avg_buy_price_isSet = true;
}

bool
SWGAskAccount::isAvgBuyPriceModified() {
    return avg_buy_price_modified;
}
void
SWGAskAccount::setAvgBuyPriceModified(bool avg_buy_price_modified) {
    this->avg_buy_price_modified = avg_buy_price_modified;
    this->m_avg_buy_price_modified_isSet = true;
}

QString*
SWGAskAccount::getUnitCurrency() {
    return unit_currency;
}
void
SWGAskAccount::setUnitCurrency(QString* unit_currency) {
