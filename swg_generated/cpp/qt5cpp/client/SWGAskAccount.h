...
#ifndef SWGAskAccount_H_
#define SWGAskAccount_H_
...
class SWGAskAccount: public SWGObject {
public:
    SWGAskAccount();
    SWGAskAccount(QString json);
    ~SWGAskAccount();
    void init();
    void cleanup();
    ...
    SWGAskAccount* fromJson(QString jsonString) override;
