...
SWGCandleMinutes::SWGCandleMinutes(QString json) {
    init();
    this->fromJson(json);
}

SWGCandleMinutes::SWGCandleMinutes() {
    init();
}
...
SWGCandleMinutes*
SWGCandleMinutes::fromJson(QString json) {
...
void
SWGCandleMinutes::fromJsonObject(QJsonObject pJson) {
    ...
    ::Swagger::setValue(&unit, pJson["unit"], "SWGNumber", "SWGNumber");
    
}

QString
SWGCandleMinutes::asJson ()
{
...
SWGCandleMinutes::asJsonObject() {
    ...
    if((unit != nullptr) && (unit->isSet())){
        toJsonValue(QString("unit"), unit, obj, QString("SWGNumber"));
    }
...
QString*
SWGCandleMinutes::getMarket() {
    return market;
}
void
SWGCandleMinutes::setMarket(QString* market) {
    this->market = market;
    this->m_market_isSet = true;
}

QString*
SWGCandleMinutes::getCandleDateTimeUtc() {
    return candle_date_time_utc;
}
void
SWGCandleMinutes::setCandleDateTimeUtc(QString* candle_date_time_utc) {
    this->candle_date_time_utc = candle_date_time_utc;
    this->m_candle_date_time_utc_isSet = true;
}

QString*
SWGCandleMinutes::getCandleDateTimeKst() {
    return candle_date_time_kst;
}
void
SWGCandleMinutes::setCandleDateTimeKst(QString* candle_date_time_kst) {
    this->candle_date_time_kst = candle_date_time_kst;
    this->m_candle_date_time_kst_isSet = true;
}

double
SWGCandleMinutes::getOpeningPrice() {
    return opening_price;
}
void
SWGCandleMinutes::setOpeningPrice(double opening_price) {
    this->opening_price = opening_price;
    this->m_opening_price_isSet = true;
}

double
SWGCandleMinutes::getHighPrice() {
    return high_price;
}
void
SWGCandleMinutes::setHighPrice(double high_price) {
    this->high_price = high_price;
    this->m_high_price_isSet = true;
}

double
SWGCandleMinutes::getLowPrice() {
    return low_price;
}
void
SWGCandleMinutes::setLowPrice(double low_price) {
    this->low_price = low_price;
    this->m_low_price_isSet = true;
}

double
SWGCandleMinutes::getTradePrice() {
    return trade_price;
}
void
SWGCandleMinutes::setTradePrice(double trade_price) {
    this->trade_price = trade_price;
    this->m_trade_price_isSet = true;
}

SWGNumber*
SWGCandleMinutes::getTimestamp() {
    return timestamp;
}
void
SWGCandleMinutes::setTimestamp(SWGNumber* timestamp) {
    this->timestamp = timestamp;
    this->m_timestamp_isSet = true;
}

double
SWGCandleMinutes::getCandleAccTradePrice() {
    return candle_acc_trade_price;
}
void
SWGCandleMinutes::setCandleAccTradePrice(double candle_acc_trade_price) {
    this->candle_acc_trade_price = candle_acc_trade_price;
    this->m_candle_acc_trade_price_isSet = true;
}

double
SWGCandleMinutes::getCandleAccTradeVolume() {
    return candle_acc_trade_volume;
}
void
SWGCandleMinutes::setCandleAccTradeVolume(double candle_acc_trade_volume) {
    this->candle_acc_trade_volume = candle_acc_trade_volume;
    this->m_candle_acc_trade_volume_isSet = true;
}

SWGNumber*
SWGCandleMinutes::getUnit() {
    return unit;
}
void
SWGCandleMinutes::setUnit(SWGNumber* unit) {
    this->unit = unit;
...
SWGCandleMinutes::isSet(){
    ...
    do{
        ...
        if(unit != nullptr && unit->isSet()){ isObjectUpdated = true; break;}
    }while(false);
