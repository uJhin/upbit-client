...
#ifndef SWGCandleDate_H_
#define SWGCandleDate_H_
...
class SWGCandleDate: public SWGObject {
public:
    SWGCandleDate();
    SWGCandleDate(QString json);
    ~SWGCandleDate();
    void init();
    void cleanup();
    ...
    SWGCandleDate* fromJson(QString jsonString) override;
    ...
    QString* getFirstDayOfPeriod();
    void setFirstDayOfPeriod(QString* first_day_of_period);
...
private:
    ...
    QString* first_day_of_period;
    bool m_first_day_of_period_isSet;

};

}

#endif /* SWGCandleDate_H_ */
