...
#ifndef SWGNewOrder_H_
#define SWGNewOrder_H_
...
class SWGNewOrder: public SWGObject {
public:
    SWGNewOrder();
    SWGNewOrder(QString json);
    ~SWGNewOrder();
    void init();
    void cleanup();
    ...
    SWGNewOrder* fromJson(QString jsonString) override;
    ...
    QString* getAvgPrice();
    void setAvgPrice(QString* avg_price);
