...
void SwaggerCandleDate::WriteJson(JsonWriter& Writer) const
{
	...
	if (FirstDayOfPeriod.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("first_day_of_period")); WriteJsonValue(Writer, FirstDayOfPeriod.GetValue());	
	}
	Writer->WriteObjectEnd();
}

bool SwaggerCandleDate::FromJson(const TSharedPtr<FJsonObject>& JsonObject)
{
	...
	ParseSuccess &= TryGetJsonValue(JsonObject, TEXT("first_day_of_period"), FirstDayOfPeriod);
