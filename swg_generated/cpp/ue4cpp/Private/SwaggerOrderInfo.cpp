...
void SwaggerOrderInfo::WriteJson(JsonWriter& Writer) const
{
	...
	if (Trades.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("trades")); WriteJsonValue(Writer, Trades.GetValue());	
	}
	Writer->WriteObjectEnd();
}

bool SwaggerOrderInfo::FromJson(const TSharedPtr<FJsonObject>& JsonObject)
{
	...
	ParseSuccess &= TryGetJsonValue(JsonObject, TEXT("trades"), Trades);
