...
#ifndef IO_SWAGGER_CLIENT_MODEL_OrderInfo_H_
#define IO_SWAGGER_CLIENT_MODEL_OrderInfo_H_
...
public:
    ...
    /// 체결
    /// </summary>
    std::vector<std::shared_ptr<Trade>>& getTrades();
    bool tradesIsSet() const;
    void unsetTrades();
    void setTrades(std::vector<std::shared_ptr<Trade>> value);
...
#endif /* IO_SWAGGER_CLIENT_MODEL_OrderInfo_H_ */
