...
#ifndef IO_SWAGGER_CLIENT_MODEL_CandleDays_H_
#define IO_SWAGGER_CLIENT_MODEL_CandleDays_H_
...
public:
    ...
    /// </summary>
    double getConvertedTradePrice() const;
    bool convertedTradePriceIsSet() const;
    void unsetConverted_trade_price();
    void setConvertedTradePrice(double value);
...
protected:
    ...
    double m_Converted_trade_price;
    bool m_Converted_trade_priceIsSet;
};
...
#endif /* IO_SWAGGER_CLIENT_MODEL_CandleDays_H_ */
