...
std::shared_ptr<BidAccount> Market::getBidAccount() const
{
    return m_Bid_account;
}


void Market::setBidAccount(std::shared_ptr<BidAccount> value)
{
    m_Bid_account = value;
    m_Bid_accountIsSet = true;
}
bool Market::bidAccountIsSet() const
{
    return m_Bid_accountIsSet;
}

void Market::unsetBid_account()
{
    m_Bid_accountIsSet = false;
}

std::shared_ptr<AskAccount> Market::getAskAccount() const
{
    return m_Ask_account;
}


void Market::setAskAccount(std::shared_ptr<AskAccount> value)
{
    m_Ask_account = value;
    m_Ask_accountIsSet = true;
}
bool Market::askAccountIsSet() const
{
    return m_Ask_accountIsSet;
}

void Market::unsetAsk_account()
{
    m_Ask_accountIsSet = false;
}
