...
void BidAccount::validate()
{
    // TODO: implement validation
}

web::json::value BidAccount::toJson() const
{
...
void BidAccount::fromJson(web::json::value& val)
{
...
void BidAccount::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void BidAccount::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t BidAccount::getCurrency() const
{
    return m_Currency;
}


void BidAccount::setCurrency(utility::string_t value)
{
    m_Currency = value;
    m_CurrencyIsSet = true;
}
bool BidAccount::currencyIsSet() const
{
    return m_CurrencyIsSet;
}

void BidAccount::unsetCurrency()
{
    m_CurrencyIsSet = false;
}

utility::string_t BidAccount::getBalance() const
{
    return m_Balance;
}


void BidAccount::setBalance(utility::string_t value)
{
    m_Balance = value;
    m_BalanceIsSet = true;
}
bool BidAccount::balanceIsSet() const
{
    return m_BalanceIsSet;
}

void BidAccount::unsetBalance()
{
    m_BalanceIsSet = false;
}

utility::string_t BidAccount::getLocked() const
{
    return m_Locked;
}


void BidAccount::setLocked(utility::string_t value)
{
    m_Locked = value;
    m_LockedIsSet = true;
}
bool BidAccount::lockedIsSet() const
{
    return m_LockedIsSet;
}

void BidAccount::unsetLocked()
{
    m_LockedIsSet = false;
}

utility::string_t BidAccount::getAvgBuyPrice() const
{
    return m_Avg_buy_price;
}


void BidAccount::setAvgBuyPrice(utility::string_t value)
{
    m_Avg_buy_price = value;
    m_Avg_buy_priceIsSet = true;
}
bool BidAccount::avgBuyPriceIsSet() const
{
    return m_Avg_buy_priceIsSet;
}

void BidAccount::unsetAvg_buy_price()
{
    m_Avg_buy_priceIsSet = false;
}

bool BidAccount::isAvgBuyPriceModified() const
{
    return m_Avg_buy_price_modified;
}


void BidAccount::setAvgBuyPriceModified(bool value)
{
    m_Avg_buy_price_modified = value;
    m_Avg_buy_price_modifiedIsSet = true;
}
bool BidAccount::avgBuyPriceModifiedIsSet() const
{
    return m_Avg_buy_price_modifiedIsSet;
}

void BidAccount::unsetAvg_buy_price_modified()
{
    m_Avg_buy_price_modifiedIsSet = false;
}

utility::string_t BidAccount::getUnitCurrency() const
{
    return m_Unit_currency;
}


void BidAccount::setUnitCurrency(utility::string_t value)
{
    m_Unit_currency = value;
    m_Unit_currencyIsSet = true;
}
bool BidAccount::unitCurrencyIsSet() const
{
    return m_Unit_currencyIsSet;
}

void BidAccount::unsetUnit_currency()
{
    m_Unit_currencyIsSet = false;
}
