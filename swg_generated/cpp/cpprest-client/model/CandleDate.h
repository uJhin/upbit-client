...
#ifndef IO_SWAGGER_CLIENT_MODEL_CandleDate_H_
#define IO_SWAGGER_CLIENT_MODEL_CandleDate_H_
...
public:
    ...
    /// 캔들 기간의 가장 첫 날
    /// </summary>
    utility::string_t getFirstDayOfPeriod() const;
    bool firstDayOfPeriodIsSet() const;
    void unsetFirst_day_of_period();
    void setFirstDayOfPeriod(utility::string_t value);
...
protected:
    ...
    utility::string_t m_First_day_of_period;
    bool m_First_day_of_periodIsSet;
};
...
#endif /* IO_SWAGGER_CLIENT_MODEL_CandleDate_H_ */
