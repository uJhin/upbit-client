...
public class OrderApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call orderInfoAllCall(String market, String state, List<String> states, List<String> uuids, List<String> identifiers, String kind, BigDecimal page, BigDecimal limit, String orderBy, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call orderInfoAllValidateBeforeCall(String market, String state, List<String> states, List<String> uuids, List<String> identifiers, String kind, BigDecimal page, BigDecimal limit, String orderBy, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = orderInfoAllCall(market, state, states, uuids, identifiers, kind, page, limit, orderBy, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Order> orderInfoAll(String market, String state, List<String> states, List<String> uuids, List<String> identifiers, String kind, BigDecimal page, BigDecimal limit, String orderBy) throws ApiException {
        ApiResponse<List<Order>> resp = orderInfoAllWithHttpInfo(market, state, states, uuids, identifiers, kind, page, limit, orderBy);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Order>> orderInfoAllWithHttpInfo(String market, String state, List<String> states, List<String> uuids, List<String> identifiers, String kind, BigDecimal page, BigDecimal limit, String orderBy) throws ApiException {
        com.squareup.okhttp.Call call = orderInfoAllValidateBeforeCall(market, state, states, uuids, identifiers, kind, page, limit, orderBy, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call orderInfoAllAsync(String market, String state, List<String> states, List<String> uuids, List<String> identifiers, String kind, BigDecimal page, BigDecimal limit, String orderBy, final ApiCallback<List<Order>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = orderInfoAllValidateBeforeCall(market, state, states, uuids, identifiers, kind, page, limit, orderBy, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Order>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param volume 주문량 (지정가, 시장가 매도 시 필수)  (required)
     * @param price 주문 가격. (지정가, 시장가 매수 시 필수)  ex) KRW-BTC 마켓에서 1BTC당 1,000 KRW로 거래할 경우, 값은 1000 이 된다. ex) KRW-BTC 마켓에서 1BTC당 매도 1호가가 500 KRW 인 경우, 시장가 매수 시 값을 1000으로 세팅하면 2BTC가 매수된다. (수수료가 존재하거나 매도 1호가의 수량에 따라 상이할 수 있음)  (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call orderNewCall(String market, String side, String volume, String price, String ordType, String identifier, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call orderNewValidateBeforeCall(String market, String side, String volume, String price, String ordType, String identifier, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (volume == null) {
            throw new ApiException("Missing the required parameter 'volume' when calling orderNew(Async)");
        }
        ...
        com.squareup.okhttp.Call call = orderNewCall(market, side, volume, price, ordType, identifier, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public NewOrder orderNew(String market, String side, String volume, String price, String ordType, String identifier) throws ApiException {
        ApiResponse<NewOrder> resp = orderNewWithHttpInfo(market, side, volume, price, ordType, identifier);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<NewOrder> orderNewWithHttpInfo(String market, String side, String volume, String price, String ordType, String identifier) throws ApiException {
        com.squareup.okhttp.Call call = orderNewValidateBeforeCall(market, side, volume, price, ordType, identifier, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call orderNewAsync(String market, String side, String volume, String price, String ordType, String identifier, final ApiCallback<NewOrder> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = orderNewValidateBeforeCall(market, side, volume, price, ordType, identifier, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<NewOrder>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
