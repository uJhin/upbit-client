...
public class OrderApiTest {
    ...
    public void orderInfoAllTest() throws ApiException {
        ...
        String orderBy = null;
        List<Order> response = api.orderInfoAll(market, state, states, uuids, identifiers, kind, page, limit, orderBy);
    ...
    public void orderNewTest() throws ApiException {
        ...
        String ordType = null;
        String identifier = null;
        NewOrder response = api.orderNew(market, side, volume, price, ordType, identifier);
