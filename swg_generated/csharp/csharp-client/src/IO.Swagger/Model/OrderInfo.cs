...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderInfo :  IEquatable<OrderInfo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="trades">체결.</param>
        public OrderInfo(string uuid = default(string), string side = default(string), string ordType = default(string), string price = default(string), string state = default(string), string market = default(string), string createdAt = default(string), string volume = default(string), string remainingVolume = default(string), string reservedFee = default(string), string remainingFee = default(string), string paidFee = default(string), string locked = default(string), string executedVolume = default(string), decimal? tradesCount = default(decimal?), List<Trade> trades = default(List<Trade>))
        {
            this.Uuid = uuid;
            this.Side = side;
