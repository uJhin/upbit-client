...
namespace IO.Swagger.Model
{
    ...
    public partial class Market :  IEquatable<Market>, IValidatableObject
    {
        ...
        public Market(string id = default(string), string name = default(string), List<string> orderTypes = default(List<string>), List<string> orderSides = default(List<string>), Bid bid = default(Bid), Ask ask = default(Ask), string maxTotal = default(string), string state = default(string), BidAccount bidAccount = default(BidAccount), AskAccount askAccount = default(AskAccount))
        {
            this.Id = id;
            this.Name = name;
