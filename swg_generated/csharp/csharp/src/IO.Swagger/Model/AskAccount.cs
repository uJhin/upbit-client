...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AskAccount :  IEquatable<AskAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AskAccount" /> class.
        /// </summary>
        ...
        public AskAccount(string currency = default(string), string balance = default(string), string locked = default(string), string avgBuyPrice = default(string), bool? avgBuyPriceModified = default(bool?), string unitCurrency = default(string))
        {
        ...
        {
            return this.Equals(input as AskAccount);
        }

        /// <summary>
        /// Returns true if AskAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of AskAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AskAccount input)
        {
            if (input == null)
                return false;
