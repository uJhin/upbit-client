...
namespace IO.Swagger.Model
{
    ...
    public partial class Deposit :  IEquatable<Deposit>, IValidatableObject
    {
        ...
        /// <param name="uuid">입금에 대한 고유 아이디.</param>
        /// <param name="currency">화폐를 의미하는 영문 대문자 코드.</param>
        /// <param name="txid">입금의 트랜잭션 아이디.</param>
        /// <param name="state">입금 상태.</param>
        /// <param name="createdAt">입금 생성 시간.</param>
        /// <param name="doneAt">입금 완료 시간.</param>
        /// <param name="amount">입금 수량.</param>
        /// <param name="fee">입금 수수료.</param>
        /// <param name="transactionType">입금 유형 - default : 일반출금 - internal : 바로입금 .</param>
        public Deposit(string type = default(string), string uuid = default(string), string currency = default(string), string txid = default(string), string state = default(string), string createdAt = default(string), string doneAt = default(string), string amount = default(string), string fee = default(string), string transactionType = default(string))
        {
            this.Type = type;
            this.Uuid = uuid;
