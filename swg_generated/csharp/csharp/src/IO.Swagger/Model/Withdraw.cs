...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Withdraw :  IEquatable<Withdraw>, IValidatableObject
    {
        /// <summary>
        ...
        public Withdraw(string type = default(string), string uuid = default(string), string currency = default(string), string txid = default(string), string state = default(string), string createdAt = default(string), string doneAt = default(string), string amount = default(string), string fee = default(string), string transactionType = default(string))
        {
            this.Type = type;
            this.Uuid = uuid;
