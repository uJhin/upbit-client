...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CandleMinutes :  IEquatable<CandleMinutes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CandleMinutes" /> class.
        /// </summary>
        ...
        /// <param name="unit">분 단위(유닛).</param>
        public CandleMinutes(string market = default(string), string candleDateTimeUtc = default(string), string candleDateTimeKst = default(string), double? openingPrice = default(double?), double? highPrice = default(double?), double? lowPrice = default(double?), double? tradePrice = default(double?), decimal? timestamp = default(decimal?), double? candleAccTradePrice = default(double?), double? candleAccTradeVolume = default(double?), decimal? unit = default(decimal?))
        {
            this.Market = market;
        ...
        {
            return this.Equals(input as CandleMinutes);
        }

        /// <summary>
        /// Returns true if CandleMinutes instances are equal
        /// </summary>
        /// <param name="input">Instance of CandleMinutes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CandleMinutes input)
        {
            if (input == null)
                return false;
