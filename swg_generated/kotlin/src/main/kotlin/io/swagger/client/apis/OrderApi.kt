...
class OrderApi(basePath: kotlin.String = "https://api.upbit.com/v1") : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun order.infoAll(market: kotlin.String, state: kotlin.String, states: kotlin.Array<kotlin.String>, uuids: kotlin.Array<kotlin.String>, identifiers: kotlin.Array<kotlin.String>, kind: kotlin.String, page: java.math.BigDecimal, limit: java.math.BigDecimal, orderBy: kotlin.String) : kotlin.Array<Order> {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf("market" to listOf("$market"), "state" to listOf("$state"), "states" to toMultiValue(states.toList(), "multi"), "uuids" to toMultiValue(uuids.toList(), "multi"), "identifiers" to toMultiValue(identifiers.toList(), "multi"), "kind" to listOf("$kind"), "page" to listOf("$page"), "limit" to listOf("$limit"), "order_by" to listOf("$orderBy"))
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun order.new(market: kotlin.String, side: kotlin.String, volume: kotlin.String, price: kotlin.String, ordType: kotlin.String, identifier: kotlin.String) : NewOrder {
