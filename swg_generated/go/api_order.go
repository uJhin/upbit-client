 ...
 * @param optional nil or *OrderApiOrderInfoAllOpts - Optional Parameters:
     ...
     * @param "Kind" (optional.String) -  주문 유형 - normal : 일반 주문 - watch : 예약 주문 
...
func (a *OrderApiService) OrderNew(ctx context.Context, market string, side string, volume string, price string, ordType string, localVarOptionals *OrderApiOrderNewOpts) (NewOrder, *http.Response, error) {
	var (
	...
	localVarFormParams.Add("volume", parameterToString(volume, ""))
